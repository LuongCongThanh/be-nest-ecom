...
CRUD ở đây **không phải public CRUD** — là cổng vận hành dành cho `ADMIN`/`STAFF` để xử lý support ticket, vi phạm chính sách, audit. End-user dùng [`TASK-119 Profile`](./TASK-119-Implement-User-Profile.md) cho thao tác cá nhân.
